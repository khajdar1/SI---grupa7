...
ALTER TABLE `Notification`
  MODIFY `type` ENUM('NEW_REPORT', 'INTERVENTION_ASSIGNED', 'STATUS_CHANGED', 'FEEDBACK_REQUEST', 'AUTO_ASSIGNMENT', 'NEW_TICKET', 'TICKET_REPLY', 'INTERVENTION_PAUSED') NOT NULL;
