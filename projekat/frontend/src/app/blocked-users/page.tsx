...
const copy = {
  ...
  bs: {
    ...
    reasonPlaceholder: 'Opišite razlog blokiranja...',
    cancel: 'Odustani',
    blocking: 'Blokiranje...',
    block: 'Blokiraj',
    confirmUnblock: 'Potvrdi deblokiranje',
    unblockDescriptionStart: 'Da li ste sigurni da želite deblokirati korisnika',
    unblockDescriptionEnd: 'Korisnik će odmah moći ponovo podnositi prijave kvarova.',
