...
|----|-------------|------|-----|----------|-----------|--------|----------------|----------|
| PBI-001 | Registracija korisnika | Kreiranje korisničkog računa s unosom osnovnih podataka i dodjelom uloge (korisnik, serviser, koordinator, admin, menadžment) | Feature | Kritičan | 5 SP | Todo | Sprint 5 | Pri samoregistraciji dodjeljuje se uloga Gost/Korisnik; Admin kreira račune za zaposlene i povezuje ih sa odgovarajućom firomom/organizacijom |
