...
| PBI-011 | Historija intervencija po lokaciji/uređaju | Pregled prethodnih intervencija filtriranih prema lokaciji ili uređaju, s osnovnim podacima o svakoj intervenciji | Feature | Srednji | 3 SP | Todo | Sprint 6 | Osnovna historija bez grafičkih prikaza (van MVP scope) |
...
| PBI-016 | Komentari intervencije | Koordinator i serviser mogu dodavati tekstualne komentare na intervenciju radi dodatnog pojašnjenja, evidencije ili prijave kašnjenja | Feature | Srednji | 3 SP | Todo | Sprint 6 | Potrebna procjena SP na sljedećem refinementu |
...
| PBI-033 | Pregled i upravljanje attachmentima | Koordinator i admin mogu pregledati, validirati i brisati fajlove priložene u prijavi kvara. Uključuje definisanje dozvoljenih tipova fajlova i maksimalne veličine. | Feature | Visok | 3 SP | Todo | Sprint 6 | Zavisi od PBI-003 (upload fajlova) |
