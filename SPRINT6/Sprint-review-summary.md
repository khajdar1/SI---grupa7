...
PBI-005 — Pregled liste aktivnih intervencija
PBI-006 — Dodjela servisera intervenciji
PBI-007 — Postavljanje prioriteta intervencije
...
Test Proof
Sve ostale planirane stavke za Sprint 6 su uspješno završene.
...
Serviserima je omogućen pristup historiji intervencija kao pomoć pri rješavanju sličnih slučajeva.
Intervencije se automatski kreiraju nakon prijave kvara.
7. Povratna informacija Product Ownera
Product Owner je zadovoljan implementacijskim dijelom sprinta, međutim zbog nedostatka prateće dokumentacije, odnosno Sprint Retrospective i Test Proof dokumentacije, timu je dodijeljeno 75% bodova.
8. Zaključak za naredni sprint
Za Sprint 7 planiran je nastavak implementacije sljedećih funkcionalnosti:
Menadžment dashboard
Upravljanje korisničkim profilom
Kalendarski prikaz intervencija
Placeholder funkcionalnosti za kreiranje kompanija, uključujući administratorsko kreiranje, samoprijavu i stranicu kompanije